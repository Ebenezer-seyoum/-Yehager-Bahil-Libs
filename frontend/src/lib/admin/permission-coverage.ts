...
export const DASHBOARD_PERMISSION_REQUIREMENTS: PermissionRequirement[] = [
  ...
  { area: "Collections", route: "/admin/sections", feature: "Manage homepage collections", action: "Manage", permissionKey: "products.edit" },
  { area: "Orders", route: "/admin/orders", subLinks: ["Catalog Orders"], feature: "View orders", action: "View", permissionKey: "orders.view" },
  { area: "Orders", route: "/admin/orders", subLinks: ["Catalog Orders"], feature: "Edit order details", action: "Edit", permissionKey: "orders.edit" },
  { area: "Orders", route: "/admin/orders", subLinks: ["Catalog Orders"], feature: "Change order status", action: "Manage", permissionKey: "orders.status.update" },
  { area: "Orders", route: "/admin/orders", subLinks: ["Catalog Orders"], feature: "Delete or cancel order", action: "Delete", permissionKey: "orders.delete" },
  ...
  { area: "Uploaded Designs", route: "/admin/uploaded-designs", subLinks: ["Custom Orders"], feature: "View uploaded designs", action: "View", permissionKey: "uploaded_designs.view" },
  ...
  { area: "Coupons & Discounts", route: "/admin/finance/coupons-discounts", feature: "View coupon and discount activity", action: "View", permissionKey: "coupons.view" },
  { area: "Coupons & Discounts", route: "/admin/finance/coupons-discounts", feature: "Create or update coupon rules", action: "Edit", permissionKey: "coupons.edit" },
  { area: "Order Documents", route: "/admin/orders/documents", feature: "View order documents", action: "View", permissionKey: "documents.view" },
  { area: "Order Documents", route: "/admin/orders/documents", feature: "Upload document", action: "Create", permissionKey: "documents.upload" },
  ...
  { area: "Order Documents", route: "/admin/orders/documents/[id]", feature: "Edit document", action: "Edit", permissionKey: "documents.update", note: "Missing if document editing is required." },
  { area: "Order Documents", route: "/admin/orders/documents/[id]", feature: "Delete document", action: "Delete", permissionKey: "documents.delete", note: "Missing if document deletion is required." },
  { area: "Order Documents", route: "/admin/orders/documents/[id]", feature: "Download document", action: "Download", permissionKey: "documents.download", note: "Missing if document downloads need separate control." },
