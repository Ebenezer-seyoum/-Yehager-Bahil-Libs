...
// Lightweight, static calling-code list for phone input UX.
// Sorted by name for easier searching in native <select>.
export const COUNTRY_CALLING_CODES: CountryCallingCode[] = [
  ...
  { name: "Ethiopia", iso2: "ET", iso3: "ETH", dialCode: "+251" },
  ...
  { name: "Kenya", iso2: "KE", iso3: "KEN", dialCode: "+254" },
  ...
  { name: "United Kingdom", iso2: "GB", iso3: "GBR", dialCode: "+44" },
  { name: "United States", iso2: "US", iso3: "USA", dialCode: "+1" },
