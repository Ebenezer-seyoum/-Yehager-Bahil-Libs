...
export function AdminProductDetailPanel({
  ...
  function renderTelegramPricing() {
    ...
    const retryTelegram = async () => {
      await patchProduct({ sendToTelegram: true, priceStatus: "waiting_price" }, "Telegram pricing send requested again.");
    };
    return (
      <div className="space-y-5">
