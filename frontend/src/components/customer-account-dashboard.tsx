      ...
      <div className="mb-8 rounded-2xl bg-foreground p-6 text-background sm:p-8">
        <div className="flex flex-wrap items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-2">
            ...
            <button type="button" onClick={() => { window.location.href = "/api/logout"; }} className="inline-flex items-center gap-2 rounded-md bg-rose-600 px-3 py-2 text-sm font-semibold text-white hover:bg-rose-700">
      ...
      <div className="rounded-2xl border border-border bg-card p-6">
        ...
        <div className="space-y-4">
          ...
          <div className="flex items-start gap-4 rounded-xl border border-destructive/20 p-4">
            ...
            <button type="button" onClick={() => { window.location.href = "/api/logout"; }} className="shrink-0 rounded-md bg-destructive px-3 py-2 text-sm font-semibold text-destructive-foreground">Sign Out</button>
          </div>
        </div>
      </div>
    </div>
